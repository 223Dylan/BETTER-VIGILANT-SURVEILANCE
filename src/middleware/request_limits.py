...
class RequestLimitsMiddleware(BaseHTTPMiddleware):
    def __init__(self, app):
        super().__init__(app)
        self.max_content_length = int(os.getenv('MAX_CONTENT_LENGTH', DEFAULT_MAX_CONTENT_LENGTH))
        self.max_header_size = int(os.getenv('MAX_HEADER_SIZE', DEFAULT_MAX_HEADER_SIZE))
