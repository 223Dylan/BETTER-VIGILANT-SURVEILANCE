...
export const PermissionManager: React.FC<PermissionManagerProps> = ({
  ...
  const handleRoleChange = (newRole: User['role']) => {
    ...
    frontendAuditService.logPermissionCheck(
      ...
      'PermissionManager',
      'role_selection',
      { targetUser: user.id, newRole, previousRole: user.role }
    );
  };
  ...
  const handlePermissionToggle = (permissionKey: keyof User['permissions']) => {
    ...
    frontendAuditService.logPermissionCheck(
      ...
      'permission_toggle',
      {
        ...
        granted: newPermissions[permissionKey]
      }
    );
  };
    ...
    try {
      ...
      frontendAuditService.logPermissionCheck(
        ...
        'save',
        {
          ...
          useRoleDefaults,
          permissionCount: Object.values(effectivePermissions).filter(Boolean).length
        }
      );
