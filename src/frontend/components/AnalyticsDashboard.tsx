...
import { Activity, Camera, Cpu, HardDrive, MemoryStick, TrendingUp, AlertTriangle, CheckCircle, Clock, Users, Eye, Zap } from 'lucide-react';
    ...
    switch (message.topic) {
      ...
      case 'analytics_aggregates':
        setAnalyticsAggregates(prev => {
          const newAggregates = [...prev, message.data];
