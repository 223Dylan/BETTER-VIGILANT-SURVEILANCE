...
class CameraDatabaseService:
    ...
    def update_camera_status(self, camera_id: str, status: str, error_message: str = None):
    ...
    def migrate_from_yaml_config(self, config_file_path: str) -> bool:
        ...
        try:
            ...
            logger.info(f"Successfully migrated {migrated_count} cameras from YAML to database")
            return True
    ...
    def _create_camera_from_list_config(self, camera_config: dict) -> Optional[Camera]:
        ...
        try:
            ...
            camera = Camera(
                ...
                source_type=self._map_camera_type(camera_config.get('camera_type', 'usb')),
    ...
    def convert_to_camera_config(self, camera: Camera) -> CameraConfig:
        ...
        return CameraConfig(
            id=camera.id,
            name=camera.name,
            location_id=advanced_settings.get('location_id', camera.location or 'unknown'),
