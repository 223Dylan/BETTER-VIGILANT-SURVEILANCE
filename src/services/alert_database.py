...
class AlertDatabaseService:
    ...
    def get_active_alerts(self, filters: Optional[Dict] = None, limit: int = 100) -> List[Dict[str, Any]]:
    ...
    def get_alert_history(self, filters: Optional[Dict] = None, limit: int = 100) -> List[Dict[str, Any]]:
    ...
    def update_alert_status(self, alert_id: str, status: str, user_id: str, notes: Optional[str] = None) -> bool:
    ...
    def get_alert_stats(self, days: int = 7) -> Dict[str, Any]:
        ...
        try:
            with self.get_session() as db:
                ...
                resolved_alerts = [a for a in recent_alerts if a.resolved_at and a.acknowledged_at]
                response_times = []
    ...
    def _apply_filters(self, query, filters: Dict):
        ...
        if 'dateRange' in filters and filters['dateRange']:
            ...
            if 'start' in date_range:
                start_date = datetime.fromisoformat(date_range['start'].replace('Z', ''))
