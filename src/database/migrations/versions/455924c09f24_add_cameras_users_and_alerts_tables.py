...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_alert_camera_timestamp", "alerts", ["camera_id", "timestamp"], unique=False
    )
    op.create_index(
        "idx_alert_severity_status", "alerts", ["severity", "status"], unique=False
    )
    op.create_index(
        "idx_alert_type_timestamp", "alerts", ["type", "timestamp"], unique=False
    )
    op.create_index(
        "idx_alert_timestamp_desc", "alerts", [sa.text("timestamp DESC")], unique=False
    )
