...
class DetectionMetricsLogger:
    ...
    def log_system_performance(
        self, camera_id: str, performance_metrics: PerformanceMetrics
    ):
    ...
    def log_detection_analytics(
        self, camera_id: str, time_window: str, analytics_data: Dict[str, Any]
    ):
    ...
    def log_camera_health(self, camera_id: str, health_data: Dict[str, Any]):
...
def log_prediction_metrics(
    ...
    detection_metrics_logger.log_prediction_result(
        camera_id, prediction_result, processing_time, performance_data
    )
