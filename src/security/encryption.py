...
class EncryptionManager:
    def __init__(self):
        ...
        try:
            ...
            if not self.symmetric_key.endswith('='):
                self.symmetric_key = urlsafe_b64encode(self.symmetric_key.encode()).decode()
        ...
        if not (os.path.exists(self.private_key_path) and os.path.exists(self.public_key_path)):
    ...
    def sign_request(self, data: Dict[str, Any], timestamp: Optional[str] = None) -> str:
